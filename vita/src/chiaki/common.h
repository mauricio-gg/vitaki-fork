...
#ifndef VITAKI_COMMON_H
#define VITAKI_COMMON_H
...
// Use our own enum name to avoid conflicts with chiaki_common.h
typedef enum {
  ...
  // Additional error codes from VitaRPS5
  CHIAKI_ERR_LOGIN_PIN_REQUEST,
  CHIAKI_ERR_INVALID_PIN,
  CHIAKI_ERR_PIN_INCORRECT,
  CHIAKI_ERR_PIN_EXPIRED,
  CHIAKI_ERR_REGIST_FAILED,
  CHIAKI_ERR_AUTH_FAILED,
  CHIAKI_ERR_IN_PROGRESS,
  CHIAKI_ERR_QUIT
} ChiakiErrorCode;
...
// NOTE: Function implementations are in chiaki_target_utils.c

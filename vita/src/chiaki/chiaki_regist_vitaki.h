...
#ifndef CHIAKI_REGIST_VITAKI_H
#define CHIAKI_REGIST_VITAKI_H
...
#endif
  /**
   * NULL unless using PSN Regist - disabled for VitaRPS5 integration
   */
  // ChiakiRudp rudp;
} ChiakiRegistInfo;
...
typedef struct chiaki_registered_host_t {
  ...
  char rp_regist_key[CHIAKI_SESSION_AUTH_SIZE];  // must be completely filled
                                                 // (pad with \0)

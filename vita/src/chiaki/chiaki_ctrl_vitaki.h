...
chiaki_ctrl_init(ChiakiCtrl *ctrl, struct chiaki_session_t *session);
...
CHIAKI_EXPORT ChiakiErrorCode chiaki_ctrl_send_message(ChiakiCtrl *ctrl,
                                                       uint16_t type,
                                                       const uint8_t *payload,
                                                       size_t payload_size);
CHIAKI_EXPORT ChiakiErrorCode ctrl_message_toggle_microphone(ChiakiCtrl *ctrl,
                                                             bool muted);
CHIAKI_EXPORT ChiakiErrorCode ctrl_message_connect_microphone(ChiakiCtrl *ctrl);
CHIAKI_EXPORT void chiaki_ctrl_set_login_pin(ChiakiCtrl *ctrl,
                                             const uint8_t *pin,
                                             size_t pin_size);
CHIAKI_EXPORT ChiakiErrorCode chiaki_ctrl_goto_bed(ChiakiCtrl *ctrl);
CHIAKI_EXPORT ChiakiErrorCode chiaki_ctrl_keyboard_set_text(ChiakiCtrl *ctrl,
                                                            const char *text);
...
CHIAKI_EXPORT ChiakiErrorCode
ctrl_message_set_fallback_session_id(ChiakiCtrl *ctrl);
